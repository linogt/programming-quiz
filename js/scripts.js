...
const questions = [
  ...
  {
    "question": "Private, Public e Protect fazem parte de qual conceito de Java?",
    "answers": [
      {
        "answer": "Herança",
        "correct": false
  ...
  {
    "question": "Qual é o laço que de repetição que é executado ao menos uma vez independente da condição?",
    "answers": [
      {
        "answer": "If",
        "correct": false
